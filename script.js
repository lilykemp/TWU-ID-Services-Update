...
},{"object-assign":16,"strict-uri-encode":20}],18:[function(require,module,exports){
...
jQuery(function($) {
  ...
  $('ul.sidebar-subnav.dropdown__list > li:last-child a').on( 'keydown', function(e) {
    checkTabKey = e.key;
    checkShiftKey = e.shiftKey;
  });

  $('ul.sidebar-subnav.dropdown__list > li:last-child a').on( 'focusout', delay(function(e) {
    if(checkTabKey === 'Tab' && checkShiftKey === false) {
      $(this).parents('.dropdown.dropdown--subnav').removeClass('dropdown--active');
    }
  }, 750));
...
jQuery(function($) {
  var facultySlider = $('.feature__faculty__slider');
  if (facultySlider.length > 0) {
    $('.feature__faculty__slider').slick({
      dots: false,
      slidesToShow: 2,
      slidesToScroll: 2,
      nextArrow: '<button aria-label="next" class="slick-next slick-arrow"><span class="svgstore svgstore--arrow_right"><svg><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/media/img/svgstore.svg#arrow_right"></use></svg></span></button>',
      prevArrow: '<button aria-label="prev" class="slick-prev slick-arrow"><span class="svgstore svgstore--arrow_left"><svg><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/media/img/svgstore.svg#arrow_left"></use></svg></span></button>',
      responsive: [
      {
        breakpoint: 480,
        settings: {
...
},{"countup.js":11}],27:[function(require,module,exports){
jQuery(function($) {
...
// Remove locationMatch and add keywordMatch to return statement GD
// Remove keywordMatch from return statement 06-18-19 GD
var filterBySearchText = function(elem) {
	...
	if (searchText.length === 0) {
	   ...
	   // var descriptionText = cleanText(
	   // $(elem).find('.filter__list__result--p p').text());
	    var keywordText = cleanText(
	      $(elem).find('.filter__list__result--link a data-filter-keyword').text());

		var elemTitleMatch = elemTitleText.indexOf(searchText) >= 0;
	   // var descriptionMatch = descriptionText.indexOf(searchText) >= 0;
		var keywordMatch  = keywordText.indexOf(searchText) >= 0;

	   // return elemTitleMatch || descriptionMatch || keywordMatch;
		return elemTitleMatch || keywordMatch;
	}
}

// Remove program buttons and add checkboxes instead GD
var filterByProgram = function(elem) {
  var activeFilterPrograms = $('.filter__program[aria-checked="true"]');
...
// Move filterBySearchText above filterByProgram GD
...
// Add filter__program class to clearFilters below GD
var clearFilters = function() {
    ...
    $('.filter__program').attr('aria-checked', 'false');
...
},{"query-string":17}],28:[function(require,module,exports){
jQuery(function($) {
  var body = $('body');
  ...
  $('.floating-menu .close-menu-button .header__small__menu--toggle').on('keyup', function(e) {
    if(e.key === 'Enter') {
      $('.btn.header__small__search--toggle').trigger('focus');
    }
  });
...
},{"../util/_parallax-element.js":43}],30:[function(require,module,exports){
jQuery(function($) {
  // var initMap;
  // var starkMap = {
  //   zoom: 11,
...
jQuery(function($) {
  var media__slider = $('.media__slider');
  if (media__slider.length > 0) {
    $('.media__slider').slick({
      nextArrow: '<button aria-label="next" class="slick-next slick-arrow"><span class="svgstore svgstore--arrow"><svg><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/media/img/svgstore.svg#arrow"></use></svg></span></button>',
      prevArrow: '<button aria-label="prev" class="slick-prev slick-arrow"><span class="svgstore svgstore--arrow"><svg><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/media/img/svgstore.svg#arrow"></use></svg></span></button>'
    });
...
jQuery(function($) {
  $('.subnav__list').each(function() {
    ...
    $('<a href="#" class="nav__toggle" aria-label="submenu"><span class="hide">Toggle</span><span class="svgstore svgstore--arrow"><svg><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/media/img/svgstore.svg#arrow"></use></svg></span></a>').insertBefore($(this));
...
//
  var residenceSlider = $('.residence__slider');
  if (residenceSlider.length > 0) {
...
jQuery(function($) {
  ...
  var subnavAddToggleBtn = function() {
    var submenu = $('.sidebar-subnav li').children('ul');
    $('<a href="#" class="sidebar-subnav__toggle" aria-label="submenu"><span class="hide">Toggle</span><span class="sidebar-subnav__toggle--open"><span class="svgstore svgstore--arrow"><svg><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/media/img/svgstore.svg#arrow"></use></svg></span></span>').insertBefore(submenu);
  }
...
},{"../../node_modules/bootstrap-sass/assets/javascripts/bootstrap/affix.js":1,"../../node_modules/bootstrap-sass/assets/javascripts/bootstrap/alert.js":2,"../../node_modules/bootstrap-sass/assets/javascripts/bootstrap/button.js":3,"../../node_modules/bootstrap-sass/assets/javascripts/bootstrap/collapse.js":4,"../../node_modules/bootstrap-sass/assets/javascripts/bootstrap/dropdown.js":5,"../../node_modules/bootstrap-sass/assets/javascripts/bootstrap/popover.js":6,"../../node_modules/bootstrap-sass/assets/javascripts/bootstrap/scrollspy.js":7,"../../node_modules/bootstrap-sass/assets/javascripts/bootstrap/tab.js":8,"../../node_modules/bootstrap-sass/assets/javascripts/bootstrap/tooltip.js":9,"../../node_modules/bootstrap-sass/assets/javascripts/bootstrap/transition.js":10,"./modules/_accordion.js":22,"./modules/_block.js":23,"./modules/_dropdown.js":24,"./modules/_feature.js":25,"./modules/_figure.js":26,"./modules/_filters.js":27,"./modules/_header.js":28,"./modules/_hero.js":29,"./modules/_maps.js":30,"./modules/_media.js":31,"./modules/_nav.js":32,"./modules/_popup.js":33,"./modules/_residence.js":34,"./modules/_resource.js":35,"./modules/_slider.js":36,"./modules/_subnav.js":37,"./modules/_tabs.js":38,"./modules/_topbar.js":39,"./util/_bootstrap-tabcollapse.js":41,"./util/_modernizr":42,"./util/_zoomin.js":44,"fastclick":12,"jquery":14,"jquery-placeholder":13,"magnific-popup":15,"respimage":18,"slick-carousel":19,"svg4everybody":21}],41:[function(require,module,exports){
!function ($) {
